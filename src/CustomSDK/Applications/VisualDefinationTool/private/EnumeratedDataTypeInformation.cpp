...
void EnumeratedDataTypeInformation::showEnumeratedDataTypeInformation(const boost::shared_ptr<EnumeratedDataType>& enumerated_data_type_shared_ptr)
{
  if(enumerated_data_type_shared_ptr)
  {
    ...
    //获取数据
    const QString& current_enumerated_data_type_name=QString::fromStdString(enumerated_data_type_shared_ptr->getEnumeratedDataTypeName());
    {//显示
...
void EnumeratedDataTypeInformation::initializeUI()
{
  ui->setupUi(this);
...
void EnumeratedDataTypeInformation::initializeFunction()
{
...
void EnumeratedDataTypeInformation::on_lineEdit_EnumeratedDataTypeName_textChanged(const QString& current_enumerated_data_type_name)
{
  ...
  {
    const QString& parent_package_complete_name = QString::fromStdString(enumerated_data_type_shared_ptr->getParentPackageCompleteName());
