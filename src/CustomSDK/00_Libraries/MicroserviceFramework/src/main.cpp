...
extern "C"
{
  MicroserviceFramework_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeMicroserviceFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeMicroserviceFramework,&dl_info))
    {
  ...
  MicroserviceFramework_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeMicroserviceFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeMicroserviceFramework,&dl_info))
    {
