...
extern "C"
{
  CommonFramework_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeCommonFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeCommonFramework,&dl_info))
    {
  ...
  CommonFramework_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeCommonFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeCommonFramework,&dl_info))
    {
