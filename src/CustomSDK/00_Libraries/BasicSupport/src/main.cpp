...
extern "C"
{
  BasicSupport_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeBasicSupport()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeBasicSupport,&dl_info))
    {
  ...
  BasicSupport_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeBasicSupport()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeBasicSupport,&dl_info))
    {
