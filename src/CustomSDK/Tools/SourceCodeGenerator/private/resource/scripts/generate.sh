...
pushd "$script_directory"
  pushd "../.."
    ...
    pushd "bin"
      ...
      #./SourceCodeGenerator --target_name "SourceCodeGenerator" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
      #./SourceCodeGenerator --target_name "SerialPortDebugger" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
      #./SourceCodeGenerator --target_name "VisualDefinationTool" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
      #./SourceCodeGenerator --target_name "PortScanner" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
      #./SourceCodeGenerator --target_name "QRCodeGenerator" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
      #./SourceCodeGenerator --target_name "RegularExpressionValidator" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
      #./SourceCodeGenerator --target_name "IdentifierChecker" -t "ExecutableProgram" -o "$CustomSDK/src/CustomSDK/Applications"
