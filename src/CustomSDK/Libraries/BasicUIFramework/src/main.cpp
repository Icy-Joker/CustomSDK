...
extern "C"
{
  BasicUIFramework_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeBasicUIFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeBasicUIFramework,&dl_info))
    {
  ...
  BasicUIFramework_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeBasicUIFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
