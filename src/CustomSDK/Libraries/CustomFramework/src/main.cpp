...
extern "C"
{
  CustomFramework_API void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeCustomFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeCustomFramework,&dl_info))
    {
  ...
  CustomFramework_API void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeCustomFramework()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeCustomFramework,&dl_info))
    {
