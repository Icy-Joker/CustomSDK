...
extern "C"
{
  void ATTRIBUTE_CONSTRUCTOR_DECLARE initializeCustomModule()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)initializeCustomModule,&dl_info))
    {
  ...
  void ATTRIBUTE_DESTRUCTOR_DECLARE finalizeCustomModule()
  {
#ifdef WIN32
#else
    Dl_info dl_info;
    if(dladdr((void*)finalizeCustomModule,&dl_info))
    {
